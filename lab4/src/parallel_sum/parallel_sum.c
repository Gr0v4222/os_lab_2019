...
int main(int argc, char **argv) {
  ...
  struct SumArgs args[threads_num]; /* массив структур, который описывает границы для суммирования элементов массива, который лежит по указателю внутри структуры. */
